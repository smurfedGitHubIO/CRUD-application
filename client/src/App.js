	...
	const get_user = () => {
		axios.get("http://localhost:3002/get_guardians_connection").then((resp) => {
			axios.get("http://localhost:3002/get_first_game_data", {
				...
				document.getElementById('character-chosen-first-game1').innerHTML = "Character Chosen";
				...
				document.getElementById('character-chosen-first-game').innerHTML = resp2.data["character-chosen"][1];
